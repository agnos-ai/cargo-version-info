...
You can use the `cargo-version-info` plugin to easily bump the
version:

```bash
# Bump version using cargo-version-info plugin
cargo version-info bump
```

Alternatively, you can manually edit `Cargo.toml`:
